export const enUS = {
  common: {
    ...
    insightsFor: "Insights for {count} source",
    insightsFor_other: "Insights for {count} sources",
    fullSource: "{count} full source",
    fullSource_other: "{count} full sources",
    fullNote: "{count} full note",
    fullNote_other: "{count} full notes",
  ...
  connectionErrors: {
    ...
    apiDesc: "The EduLoom API server could not be reached",
  ...
  navigation: {
    ...
    switchToFeature: "Switch to Learning",
  },
  learning: {
    title: "Progress & Assessment",
    description: "Multi-agent collaboration helps you plan a personalized learning path, push resources, and assess learning effectiveness.",
    selectNotebook: "Select course (notebook)",
    selectNotebookPlaceholder: "Choose a notebook",
    selectNotebookFirst: "Please select a notebook first.",
    tabPath: "Learning Path",
    tabAssessment: "Assessment",
    plan: "Plan with AI",
    replan: "Re-plan",
    planning: "Planning…",
    planningHint: "AI is planning the learning path, please wait…",
    planStarted: "Planning started",
    planStartedDesc: "AI is generating the learning path; it will refresh automatically.",
    planFailed: "Planning failed",
    noPath: "No learning path yet. Click \"Plan with AI\" to start.",
    ...
    assessmentDesc: "Multi-dimension evaluation from the learner profile, quiz artifacts and path progress, with adjustment suggestions.",
    assess: "Assess with AI",
    assessing: "Assessing…",
    assessStarted: "Assessment started",
    assessStartedDesc: "AI is analyzing learning effectiveness; it will refresh shortly.",
    assessFailed: "Assessment failed",
    noAssessment: "No assessment yet. Click \"Assess with AI\" to generate one.",
    overallComment: "Overall comment",
    suggestions: "Suggestions",
    assessedAt: "Assessed at",
    tutorSuggestTitle: "AI suggests generating a learning resource",
    tutorSuggestGenerate: "Generate",
  ...
  studio: {
    ...
    clickToViewPpt: "Slides — click to view details",
    moreSlides: "more slides",
    chooseAView: "Choose a view",
    tabArtifacts: "Generated",
    tabTemplates: "Templates",
    generate: "Generate",
    generating: "Generating…",
    contentSection: "Content",
    contentSectionDesc:
      "Select one or more notebooks and choose which sources and notes to include.",
    settingsSection: "Generation Settings",
    noNotebooksFound:
      "No notebooks found. Create a notebook and add sources first.",
    generateTitle: "Generate study resource",
    generateDesc: "Pick a notebook and preset; AI generates from its sources",
    generateTitle_report: "Generate Study Report",
    generateDesc_report:
      "Pick a notebook and preset; AI generates a structured report from its sources.",
    ...
    generateTitle_ppt: "Generate Study Slides",
    generateDesc_ppt:
      "Pick a notebook and preset; AI generates slide images page by page.",
    nameLabel: "Name",
    namePlaceholder: "Name this resource",
    ...
    instructionsPlaceholder: "Add specific requirements, e.g. focus or style",
    buildContextFailed: "Failed to build context. Please review your selections.",
    nameRequired: "Name is required",
    nameRequiredDesc: "Please provide a name for this resource.",
    profileRequired: "Preset is required",
    profileRequiredDesc: "Please select a generation preset.",
    noContent: "No content selected",
    noContentDesc:
      "Please select at least one source or note from a notebook.",
    artifactCount: "{count} items",
    emptyArtifacts: "Nothing generated yet. Use the button above to start.",
    inProgress: "Generating, please wait…",
    generationStarted: "Generation started",
    generationStartedDesc: "It will appear here when finished",
    failedToStartGeneration: "Failed to start generation",
    artifactDeleted: "Deleted",
    failedToDelete: "Failed to delete",
    retry: "Retry",
    retryStarted: "Resubmitted",
    failedToRetry: "Failed to retry",
    templatesDesc: "Manage generation presets for this type. Built-in presets are read-only.",
    ...
    presetPrompt: "Prompt",
    profileCreated: "Preset created",
    profileUpdated: "Preset updated",
    profileDeleted: "Preset deleted",
    failedToSaveProfile: "Failed to save preset",
    failedToDeleteProfile: "Failed to delete preset",
    recommend: "AI recommend",
    recommending: "Recommending…",
    recommendApplied: "Applied AI recommendation",
    recommendFailed: "Recommendation failed",
    recommendReasonLabel: "Why",
    status: {
      running: "Generating",
      processing: "Processing",
      pending: "Queued",
  ...
  learnerProfile: {
    ...
    subtitle: "A learning profile the system builds and continuously updates from your conversations",
    reanalyze: "Re-analyze",
    reset: "Reset",
    empty: "Nothing yet — the profile is generated automatically as you chat",
    ...
    deleteEntry: "Delete",
    content: "Content",
    extractSubmitted: "Analysis submitted; the profile will update in the background",
    resetSuccess: "Profile reset",
    resetConfirm: "Clear the entire learner profile? This cannot be undone.",
    extractDialogTitle: "Analyze conversation",
    extractDialogDesc: "Paste a conversation and the system will extract profile features from it",
    conversationPlaceholder: "Paste conversation text here…",
    submit: "Submit",
    dimensions: {
      knowledge_base: "Knowledge Base",
      cognitive_style: "Cognitive Style",
      error_prone: "Error-prone Points",
  ...
  notebooks: {
    ...
    activeNotebooks: "Current Notebooks",
    ...
    notebookCreated: "Notebook created {time}",
    notebookUpdated: "Notebook updated {time}",
    detailPageDescription: "Manage sources, view notes, and chat with AI based on notebook content.",
  ...
  searchPage: {
    ...
    askPlaceholder: "Ask a question above, AI will answer based on your knowledge base",
    searchPlaceholder: "Enter keywords to search your knowledge base",
    notSet: "Not set",
  ...
  podcasts: {
    ...
    noContentSelectedStatus: "No content selected",
    contentSelectedStatus: "Selected {sourceCount} sources, {noteCount} notes",
    summary: "Summary",
    ...
    noEpisodesYet: "No podcast episodes yet",
    createFirst: "Use the button above to generate your first podcast.",
    ...
    speakerProfileRequired: "Speaker profile is required",
    loadingVoices: "Loading voices...",
    selectVoice: "Select voice",
    male: "Male",
    female: "Female",
    customVoice: "Custom voice...",
    customVoicePlaceholder: "Custom voice ID",
  },
  settings: {
    ...
    filesHelp: "Once your files are uploaded and processed, they are not required anymore. Most users should allow EduLoom to delete uploaded files from the upload folder automatically.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "A new version of EduLoom is available.",
    upToDate: "Up to Date",
    unknown: "Unknown",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configure which models to use for different purposes across EduLoom",
    missingRequiredModels: "Missing required models: {models}. EduLoom may not function properly without these.",
    ...
    toolsModelDesc: "Used for function calling",
    largeContextModelLabel: "Large Context Model",
    largeContextModelDesc: "Used for processing large documents",
    ...
    sttModelDesc: "Not required if the model itself supports audio input",
  ...
  apiKeys: {
    ...
    description: "Store API keys securely in the database to enable AI providers in EduLoom.",
