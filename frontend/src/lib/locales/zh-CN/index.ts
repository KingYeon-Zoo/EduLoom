export const zhCN = {
  ...
  studio: {
    ...
    reportDesc: "基于来源由 AI 生成结构化学习报告",
    videoDesc: "基于来源生成教学视频概览",
    mindmapDesc: "基于来源生成可视化思维导图",
    pptDesc: "由 AI 逐页生成幻灯片图像并拼接为学习 PPT",
    quizDesc: "基于来源由 AI 生成测试题（含答案与解析）",
    slide: "幻灯片",
    downloadPpt: "下载 PPT",
    chooseAView: "选择视图",
    tabArtifacts: "已生成",
    ...
    generateDesc: "选择笔记本与预设，AI 将基于来源内容生成资源",
    nameLabel: "名称",
