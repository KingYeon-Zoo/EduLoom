...
export default function FloatingLines({
  ...
  const getLineDistance = (waveType: WaveName): number => {
    ...
    const index = enabledWaves.indexOf(waveType)
    return (lineDistance[index] ?? 0.1) * 0.01
  }
  ...
  const topLineDistance = enabledWaves.includes('top') ? getLineDistance('top') : 0.01
  const middleLineDistance = enabledWaves.includes('middle') ? getLineDistance('middle') : 0.01
  const bottomLineDistance = enabledWaves.includes('bottom') ? getLineDistance('bottom') : 0.01
