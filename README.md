...
**[✨ 核心能力](#-核心能力对应赛题五大功能)** · **[🤖 多智能体架构](#-多智能体协同架构)** · **[🛠️ 技术栈](#️-技术栈)** · **[🚀 快速开始](#-快速开始)** · **[📂 项目结构](#-项目结构)**
...
> _Edu·cation + Loom（织机）_ ——像织机将散乱的丝线编织成布一样，
> 由一组分工明确的智能体，把零散知识编织成结构化、可推送、可评估的个性化学习网络。
...
**EduLoom（学织）** 是一款开源、本地优先、以隐私为核心的高等教育个性化学习系统。

面对"**学习资源繁杂无序、难以精准匹配个体需求、缺乏智能化指导**"的真实痛点，EduLoom 以 **多智能体（Multi-Agent）协同** 为核心，把学生上传的课程文档、文献、网页等原始材料，自动编织成一整套 **多模态、个性化、随学随新** 的学习资源与学习路径，真正落地"因材施教"的数字化愿景。
...
### 🔒 隐私优先
所有 API 密钥经 **Fernet 加密** 本地存储；<br/>可搭配本地模型与本地数据库**完全离线运行**，数据不出本机。

</td>
<td width="33%" align="center">

### 🧩 多智能体协同
**薄协调器 + 角色清晰的专职智能体**，<br/>让"多智能体协作"在架构与 UI 中**清晰可见**。

</td>
<td width="33%" align="center">

### 🎨 多模态生成
一次生成 **≥5 种** 多模态资源：<br/>讲解文档 · 题库 · 思维导图 · 课件 · 教学视频。
...
> `AGENT_ROSTER` 是"谁在协作"的唯一事实来源（single source of truth），同时驱动 UI 展示与文档，确保架构描述与运行时行为始终一致。
...
| 服务 | 端口 | 说明 |
| :--- | :--- | :--- |
| **SurrealDB** | `:8000` | 图 + 向量数据库 |
| **FastAPI 后端** | `:5055` | 含异步 worker |
